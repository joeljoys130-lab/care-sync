...
const AppointmentCard = ({ appointment, role = 'patient', onCancel }) => {
  ...
  return (
    <div className="bg-white dark:bg-[#131d30]/60 rounded-2xl border border-slate-200 dark:border-white/5 shadow-card p-5 flex flex-col sm:flex-row sm:items-center gap-4">
      {/* Icon */}
